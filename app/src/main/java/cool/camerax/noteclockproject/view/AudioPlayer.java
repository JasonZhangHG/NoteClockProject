package cool.camerax.noteclockproject.view;
...
import cool.camerax.noteclockproject.utils.ResourceUtil;
...
public class AudioPlayer {
    ...
    public void play(String url, final boolean looping, final boolean vibrate) {
        ...
        try {
            ...
            ToastHelper.showShortMessage(ResourceUtil.getString(R.string.play_fail));
        }
